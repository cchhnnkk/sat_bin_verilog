...
set shortmess=aoO
badd +150 tb\class_clause_data.sv
badd +1 set_vim_path
...
badd +17 .\src\sat_engine\state_list\state_list.v
badd +34 src\sat_engine\state_list\lvl_state1.v
badd +56 src\sat_engine\state_list\lvl_states.gen
...
badd +313 tb\test_sat_engine.sv
badd +0 sim\vlog_mtime.db
badd +222 .\src\sat_engine\sat_engine.v
badd +9 tools\gen_wave_do.py
badd +1360 sim\temp.log
badd +42 tb\class_ls_list.sv
badd +0 .\src\sat_engine\ctrl_core.v
badd +88 Session.vim
silent! argdel *
edit .\src\sat_engine\ctrl_core.v
...
silent! normal! zE
let s:l = 93 - ((30 * winheight(0) + 23) / 47)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 56 - ((28 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 305 - ((18 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
305
...
wincmd w
argglobal
edit .\src\sat_engine\sat_engine.v
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 177 - ((46 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1185 - ((24 * winheight(0) + 23) / 47)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1185
